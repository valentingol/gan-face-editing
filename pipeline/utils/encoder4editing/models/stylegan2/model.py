"""Utility modules and blocks for Syle GAN."""
...
from pipeline.utils.encoder4editing.models.stylegan2.op import (
    FusedLeakyReLU, fused_leaky_relu, upfirdn2d)
...
class Downsample(nn.Module):
    """Downsample the 2D input image with upfirdn2d."""
...
class Generator(nn.Module):
    ...
    def __init__(self, size, style_dim, n_mlp, channel_multiplier=2,
        ...
        self.conv1 = StyledConv(self.channels[4], self.channels[4], 3,
                                style_dim, blur_kernel=blur_kernel)
    ...
    def mean_latent(self, n_latent):
        """Get the mean latent of the generator."""
    ...
    def forward(self, styles, return_latents=False, return_features=False,
                inject_index=None, truncation=1.0, truncation_latent=None,
        ...
        return_features : bool, optional
            Whether to return the intermediate features. By default False.
        ...
        truncation : float
            ...
            (no truncate).
        truncation_latent : torch.Tensor, optional
            The mean latent used for truncation. By default None.
        input_is_latent : bool, optional
            Whether the input is latent (w) or z. By default False.
    ...
    def __init__(self, size, channel_multiplier=2, blur_kernel=(1, 3, 3, 1)):
        ...
        self.final_linear = nn.Sequential(
            EqualLinear(channels[4] * 4 * 4, channels[4],
                        activation='fused_lrelu'), EqualLinear(channels[4], 1),
        )
